...
import click
from PIK3CA_mutation.tumor_detector import start_model as start_detector_model
from PIK3CA_mutation.sampling import start_sampling
from PIK3CA_mutation.prediction import start_models as start_prediction_model
from PIK3CA_mutation.slide2patch import run_slide2patch as start_slide2patch
from PIK3CA_mutation.stain_norm import start_stain_norm
...
def prediction(datapath, sampling_file, root_dir, seed, gpu, net, num_classes, num_workers, batch_size):
    ...
    start_prediction_model(datapath, sampling_file=sampling_file, root_dir=root_dir, seed=seed, gpu=gpu, net=net, num_classes=num_classes, num_workers=num_workers, batch_size=batch_size)
